...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        const userId1 = prompt(("Please enter your name", "Harry Potter"))
        console.log(userId1)
	...
	render(){
		return(
			<div className="app">
				<RoomList allRooms={[...this.state.joinableRooms,...this.state.joinedRooms]} 
                subscribeToRoom = {this.subscribeToRoom} 
                currentRoomId = {this.state.currentRoomId}
                /> 
				<MessageList messageList = {this.state.messageList} currentRoomId = {this.state.currentRoomId}/>
				{/* <NewRoomForm /> */}
                <NewRoomForm newRoom = {this.newRoomFromUser}/>
                <SendMessageForm sendMessage={this.sendMessageFromUser} inputDisableValue={this.state.inputDisableValue}/>
			</div>
